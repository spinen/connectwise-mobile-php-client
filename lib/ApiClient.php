...
class ApiClient
{
     ...
     */
    public function __construct(\Spinen\ConnectWise\Clients\Mobile\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Spinen\ConnectWise\Clients\Mobile\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Spinen\ConnectWise\Clients\Mobile\ObjectSerializer::sanitizeForSerialization($postData));
        }
